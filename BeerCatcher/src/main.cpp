...
int main() {
	...
	Spyen::AssetManager::LoadTexture("Food", "assets/textures/Apple.png");
	Spyen::AssetManager::LoadSound("shot", "assets/sounds/shot.mp3");
	Spyen::AssetManager::LoadTexture("Dummy", "assets/textures/Box.png");

	auto scene = Spyen::Scene::Create();

	auto entity = scene->CreateEntity("Player");
	entity.AddComponent<Spyen::SpriteRenderComponent>().Texture = Spyen::AssetManager::GetTexture("Box");
	...
	box.AddComponent<Spyen::SpriteRenderComponent>().Texture = Spyen::AssetManager::GetTexture("Food");
